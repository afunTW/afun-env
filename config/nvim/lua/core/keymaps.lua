...
-- Visual Mode
-------------------------------------------------------------------------------
keymap.set("v", "J", ":m '>+1<CR>gv=gv", { desc = "Move the selected line down"})
keymap.set("v", "K", ":m '<-2<CR>gv=gv", { desc = "Move the selected line up"})
...
-- bufferLine
keymap.set("n", "bp", ":bp<CR>", { desc = "Prev buffer" })
keymap.set("n", "bn", ":bn<CR>", { desc = "Next buffer" })
keymap.set("n", "bd", ":bd<CR>", { desc = "Close buffer" })
...
keymap.set("n", "<A-k>", "<cmd>resize +2<cr>", { desc = "Increase window height" })
keymap.set("n", "<A-j>", "<cmd>resize -2<cr>", { desc = "Decrease window height" })
